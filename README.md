...
- Uma etapa do pipeline que atualize auto a versão examples
- Adicionar teste automatizado no pipeline
- Colocar tfsec para enviar relatorio para o GitHub Security
...
| ---- | ----------- | ---- | ------- | :------: |
| <a name="input_ebs_block_devices"></a> [ebs\_block\_devices](#input\_ebs\_block\_devices) | Lista de volumes ebs para ser criado e montado na instancia | `list(any)` | n/a | yes |
| <a name="input_environment"></a> [environment](#input\_environment) | Ambiente da instancia da minha VM | `string` | `"dev"` | no |
| <a name="input_nomevm"></a> [nomevm](#input\_nomevm) | Nome da minha VM | `string` | n/a | yes |
| <a name="input_set_nome_instancias"></a> [set\_nome\_instancias](#input\_set\_nome\_instancias) | Set de nome para criar instancias | `set(string)` | `[]` | no |

## Outputs

| Name | Description |
| ---- | ----------- |
| <a name="output_public_ip"></a> [public\_ip](#output\_public\_ip) | IPS publicos |
<!-- END_TF_DOCS -->
